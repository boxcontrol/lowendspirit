...
myAPIkey = '0fd6af38241ff35b0edd1b5ab8e04caa2876a'
api_endpoint = 'https://api.cloudflare.com/client/v4' #/zones'

## make your CloudFlare object:
esindikat = Cloudflare_Enduser_API(cf_token=myAPIkey, cf_email='5n1pfet@gmail.com')


## testing
#print(esindikat.testing_query())

## Get all data associated with account:
#print(esindikat.list_all())

## Get all domains and associated ID's of the cloudflare account
pp = pprint.PrettyPrinter(indent=4)
pp.pprint(esindikat.list_domain_ids())

## Get dns records for domain with id
#print(esindikat.get_record(id='6261e6e9c365e4db31d68046982f84f6'))  # working domain
#print(esindikat.get_record('7e347b45e8b64bf285a39836444a1610'))  # another working domain
#print(esindikat.get_record('dfsafsfas'))  # not existing id test

## Get user info
#print(esindikat.get_user())
#print(esindikat.pp_print_of(some_input=esindikat.get_user().get('result')))  # with pprint
...
"""
#print(esindikat.patch_user(data))

## Get user billing profile
#print(esindikat.get_user_billing_profile('history'))
#print(esindikat.pp_print_of(some_input=esindikat.get_user_billing_profile()))   # with pprint

## Get app subscriptions
#print(esindikat.get_app_subscriptions())
#print(esindikat.get_app_subscriptions('google_analytics'))  # add 'identifier' as optional parameter

## Get firewall rules
#print(esindikat.get_firewall_rules())
#print(esindikat.pp_print_of(some_input=esindikat.get_firewall_rules().get('result')))  # with pprint

## Create access rule
"""
data = {"mode": "challenge", "configuration": {"target": "ip", "value": "1.2.3.4"},
        "notes": "This rule is on because of an event that occured on date X"}
print(esindikat.set_access_rule(data))
"""

## Update access rule
"""
data = {"mode": "block", "configuration": {"target": "ip", "value": "1.2.3.4"},
        "notes": "This rule is on because of an event that occured on date X"}
print(esindikat.set_access_rule(data))
"""

## Delete access rule
#print(esindikat.del_access_rule('ead692f89b363d87f4a18745f0d69da1'))

## Add new zone
"""
data = {"name": "maybe.com", "jump_start": 'true',
        "organization": {"id": "4e4c2b0a52a18311d16d05c666eb141c",
                         "status": "active",
                         "permissions": '["#zones:read"]'}}
print(esindikat.add_new_zone(data))
"""

## Get zone details
#print(esindikat.get_zone_details(id='6261e6e9c365e4db31d68046982f84f6'))  # working domain

## Create DNS Record
#data = {"type": "A", "name":"esindikat.com", "content": "127.0.0.1", "ttl": 120}
#print(esindikat.create_dns_record(id='6261e6e9c365e4db31d68046982f84f6', data=data))

## Get DNS records
#print(esindikat.get_dns_records(id='6261e6e9c365e4db31d68046982f84f6'))

## Get DNS record details
#print(esindikat.get_dns_record_details(id='6261e6e9c365e4db31d68046982f84f6',
#                                       record_id='a3d143047e57c6479c3a3a8328c21917'))
...
data = {"id": "a3d143047e57c6479c3a3a8328c21917",
        ...
        "locked": False,
        "zone_id": "6261e6e9c365e4db31d68046982f84f6",
        "zone_name": "esindikat.com",
        "data": {}}
print(esindikat.update_dns_record(data=data))
"""

## Delete dns record
#print(esindikat.del_dns_record(zone_id='6261e6e9c365e4db31d68046982f84f6',
#                               domain_id='a3d143047e57c6479c3a3a8328c21917'))

## Get zone analytics
#print(esindikat.get_zone_analytics(zone_id='6261e6e9c365e4db31d68046982f84f6'))
#print(esindikat.pp_print_of(some_input=esindikat.get_zone_analytics(zone_id='6261e6e9c365e4db31d68046982f84f6')))  # with pprint

## Zone firewall rules
#print(esindikat.get_zone_firewall_rules(zone_id='6261e6e9c365e4db31d68046982f84f6'))
...
print(esindikat.create_zone_firewall_rule(zone_id='6261e6e9c365e4db31d68046982f84f6', data=data))
"""